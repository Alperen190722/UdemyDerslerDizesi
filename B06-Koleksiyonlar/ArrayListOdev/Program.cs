                ...
                switch (kullaniciSecim)
                {
                    ...
                    case "3":
                        ...
                        if (kontrol)
                        {
                            ...
                            Console.WriteLine("Değeriniz Bulundu : inddex sırası :{0} - Değer : {1}",
                        ...
                        else 
                        {
                            ...
                            // Eğer aradığı kriterde değer bulamadı ise kullanıcıya bu değeri listeye
                            Console.WriteLine("Listeye eklemek ister misiniz cevabınız Evetse E tuşuna Hayırsa herhangi bir tuşa basın");
                            string kullaniciEklemeCevap = Console.ReadLine();
                            if (kullaniciEklemeCevap.ToUpper() == "E") 
                            {
                                degerListesi.Add(kullaniciAramaDeger);
                                Console.WriteLine("Değeriniz başarıyla eklendi");
                            }
                            // ekleyelim mi olarak sorun eğer kullancı E derse listeye ekleyin
                        }
                        System.Threading.Thread.Sleep(2000);
                            break;
                    case "4":
                        ...
                        Console.Write("{0} değerini hangi değer ile güncellemek istiyorsunuz",
                    ...
                    case "5":
                        ...
                        {
                            degerListesi.Clear();
                            Console.WriteLine("Tüm değerleriniz silindi");
                        }
                        else 
                        {
