...
namespace HashTableOdev
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * önceden...şeklinde sisitemimizde bulunmaktadır.
             * 
             */
            ...
            do
            {
                ...
                if (kontrol)
                {
                    Console.WriteLine("Ekleme istediğiniz değer {0} sözlük içerisinde" +
                        "bulunmaktadır. {1} değerin türkçe karşılığıdır.", eng,
                        sozlukVeriTabani[eng].ToString());
                }
                else 
                {
                ...
                Console.WriteLine("Yeni değer eklemek istiyro musunuz ? ( E/H )" );
            }
