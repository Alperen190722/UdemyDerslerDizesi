...
Public Class SATINALINANLAR
    ...
    Private Sub SATINALINANLAR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadSatinalinanlar()
    End Sub

    Private Sub LoadSatinalinanlar()
        Try
            Using connection As New SqlConnection(connectionString)
                connection.Open()
                Dim query As String = "SELECT s.satis_id, e.emlak_id, s.satis_fiyat, s.satis_tarihi, s.durum_id " &
                                      "FROM satis s " &
                                      "JOIN emlak e ON s.emlak_id = e.emlak_id " &
