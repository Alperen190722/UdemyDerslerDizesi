...
namespace GenericClassNedir2
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * tblMusteri
             * id int
             * musteriNumara uniqeidentify ( Guid )
            ...
            genericRepository<Musteri> repositoryMusteri = new 
                genericRepository<Musteri>();

            List<Musteri> musterilerim = repositoryMusteri.Getir();

            repositoryMusteri.yeniKayitEkle(null);

            genericRepository<Urun> repositoryUrun = new 
                genericRepository<Urun>();
