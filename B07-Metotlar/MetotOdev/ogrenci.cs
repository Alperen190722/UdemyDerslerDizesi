...
namespace MetotOdev
{
    internal class ogrenci
    {
        ...
        {
            Console.WriteLine("Öğrencinin Biligileri Aşağıdaki Gibidir.");
        ...
        void ortalamaNotDegerlendir(decimal ogrenciOrtalama) 
        {
            ...
            {
                Console.WriteLine("Ortalama değeriniz : {0} - Kaldınız",
                   ogrenciOrtalama);
            }
            else 
            {
                Console.WriteLine("Ortalama değeriniz : {0} - Geçtiniz",
                  ogrenciOrtalama);
            }
        }

        private decimal ortalamaHesapla(decimal Ogrencinot1, decimal Ogrencinot2, decimal 
           Ogrencinot3) 
        {
            //decimal ortalama = (Ogrencinot1 + Ogrencinot2 + Ogrencinot3) /
            //3;
            //return ortalama;
